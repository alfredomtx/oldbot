...
Class LV_InCellEdit {
   ...
   LVN_BEGINLABELEDIT(L) {
      ...
      /**
      MY EDIT: if is the first column(waypoint) or the last (Action), abort
      */
      selectedCol := This.Subitem + 1
      ; msgbox, % selectedCol " / " This.ItemText " / " selectedWaypointEdit " / " WaypointHandler.getAtribute("type", selectedWaypointEdit)
      ; msgbox, % selectedCol " / " This.ItemText " / " selectedWaypointEdit " / " WaypointHandler.getAtribute("type", selectedWaypointEdit)
      switch selectedCol {
         case 1, case 6: ; Walk / Action
            This.Cancelled := True
            PostMessage, 0x10B3, 0, 0, , % "ahk_id " . H
            If (This.EditUserFunc)
            ...
            return false
         case 5: ; Range
            action := WaypointHandler.getAtribute("type", selectedWaypointEdit)
            if (action != "Walk") && (action != "Action") {
               This.Cancelled := True
               PostMessage, 0x10B3, 0, 0, , % "ahk_id " . H
               If (This.EditUserFunc)
                  This.EditUserFunc.Call("END", This.HWND, This.HEDIT, This.Item + 1, This.Subitem + 1, ItemText)
